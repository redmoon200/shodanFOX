...
def main():
    ...
    if args.help:
        print("Usage: shodanfox -q|-qf [-d|-df|-f] [-w] [-o file]")
        print("")
        print("Options:")
        print("  -q, --query          Single query string")
        print("  -qf, --query-file    File containing queries (one per line)")
        print("  -d, --hostname       Single domain to search")
        print("  -df, --domain-file   File containing domains (one per line)")
        print("  -f, --file           File containing domains (deprecated, use -df)")
        print("  -w, --wildcard       Use wildcard search (hostname:*.domain)")
        print("  -o, --output         Output file to save results")
        print("  -r, --retries        Number of retries (default: 3)")
